...
#         print(out.shape)
#     c.close()
# np.savetxt('data/fco2_out.csv',out,delimiter=',',header='Year,Month,Latitude (deg N),Longitude (Deg E),SOCAT fCO2sw (uatm),UExP-FNN-U fCO2sw (uatm),UExP-FNN-U fCO2sw unc (uatm)')
#
# t = 0
# for file in files:
#     print(file)
...
#         print(out.shape)
#     c.close()
# np.savetxt('data/fco2_out_bio.csv',out,delimiter=',',header='Year,Month,Latitude (deg N),Longitude (Deg E),SOCAT fCO2sw (uatm),UExP-FNN-U fCO2sw (uatm),UExP-FNN-U fCO2sw unc (uatm)')
