...
def analysis(eddy_v,desc,output_loc):
    for eddy_track in np.unique(eddy_v['track']):
        ...
        if os.path.exists(output_loc+'/'+str(eddy_track)+'.nc') == False:
            ...
            Edeobs.add_sstCCI('E:/Data_n/SST-CCI/v301',radm = 3,plot=0,output_loc = output_loc,track = eddy_track,bias=0.05)
            Edeobs.add_OCCCI('F:/Data_n/OC-CCI/v6.0/daily',radm = 3,plot=0,output_loc = output_loc,track = eddy_track,bias=0)
            Edeobs.add_cmems('F:/Data_n/CMEMS/SSS/DAILY',track = eddy_track,output_loc=output_loc,var = 'so',radm = 3,plot=0,name = 'CMEMS Salinity ')
            Edeobs.add_cmems('F:/Data_n/CMEMS/MLD/DAILY',track = eddy_track,output_loc=output_loc,var = 'mlotst',radm = 3,plot=0,units='log10(m)',log10=True,depth=False, name = 'CMEMS Mixed Layer Depth ')
            Edeobs.add_wind('E:/Data_n/CCMP/V3.1',track = eddy_track,output_loc=output_loc,radm=3,plot=0)
            ...
            Edeobs.add_noaa('E:/Data_n/NOAA_ERSL/DATA/MONTHLY',output_loc,eddy_track)
            Edeobs.add_era5('F:/Data_n/ERA5/MONTHLY/DATA',output_loc,eddy_track,var='msl')
            Edeobs.add_variable_zeros(output_loc,eddy_track,'month_xco2',['ice'],'month_time')
            Edeobs.add_province('F:/NN/GCB2024_full_version_biascorrected/inputs/neural_network_input.nc',output_loc,eddy_track,prov_var ='prov_smoothed',add_text='physics')
            Edeobs.calc_anomaly_wrt_fco2net('F:/NN/Ford_et_al_SOM_chla/inputs/neural_network_input.nc',output_loc,[eddy_track],
            ...
            Edeobs.calc_fco2('F:/NN/GCB2024_full_version_biascorrected',output_loc,eddy_track,province_var = 'month_province_physics',
            ...
            Edeobs.fluxengine_run(output_loc,eddy_track,fluxengine_input_file = fluxengine_input_file,fluxengine_path=fluxengine_loc,add_text='_in_physics')
            ...
            Edeobs.fluxengine_run(output_loc,eddy_track,add_text='_out_physics',fluxengine_input_file = fluxengine_input_file,fluxengine_path=fluxengine_loc)
            ...
            """
            """
            Edeobs.add_province('F:/NN/Ford_et_al_SOM_chla/inputs/neural_network_input.nc',output_loc,eddy_track,prov_var ='prov_smoothed',add_text='bio')
            Edeobs.calc_fco2('F:/NN/Ford_et_al_SOM_chla',output_loc,eddy_track,province_var = 'month_province_bio',
            ...
            Edeobs.fluxengine_run(output_loc,eddy_track,fluxengine_input_file = fluxengine_input_file,fluxengine_path=fluxengine_loc,add_text='_in_bio')
...
config_file = 'fluxengine_config_night.conf'
...
file = 'E:/Data_n/AVISO_EDDIES/META3.2_DT_allsat_Anticyclonic_long_19930101_20220209.nc'
output_loc = 'D:/eddy/n_anticyclonic'
