...
# #eddy_t,desc = Edeobs.add_MODchl('D:\Data\MODIS\DAILY\CHL',eddy_t,desc)
# eddy_t,desc = Edeobs.add_MODpp('D:\Data\MODIS\DAILY\PP',eddy_t,desc,radm=20,plot=1)
# #eddy_t,desc = Edeobs.add_wind('D:\Data\CCMP\DAILY',eddy_t,desc,radm=3,plot=0)
# #eddy_t,desc = Edeobs.add_GlobPAR('D:\Data\GLOBCOLOUR\PAR',eddy_t,desc,radm=3,plot=0)
# #eddy_t,desc = Edeobs.compNPP_morel(eddy_t,desc,'glob_par_in_median','cci_sst_in_median','modis_chla_in_median','morel_NPP_in')
Edeobs.timeseries_save(eddy_t,desc,'OUTPUT')
